    ...
    <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr] lg:items-start">
      <div>
        ...
        <p className="measure mt-6 text-[16px] leading-relaxed">
          We are the generation who survived the untamed decades of the 70s, 80s and 90s,
          the before times of yesteryear. Raised on hose water and little to no
          supervision, we&apos;ve been adulting since elementary school. We are the last
          individuals who grew up off-line. These are our stories.
        </p>

        <p className="measure mt-4 text-[16px] leading-relaxed">
          Welcome to OUR GEN X LIFE! Come join the party and subscribe to our vlog and
          podcast.
        </p>
        ...
        <div className="mt-7 flex flex-wrap gap-3">
          ...
          <a href="/gen-x-files" className="btn-sun">
            Send us your story
          </a>
        </div>

        {/* Socials up front, so nobody has to go hunting for them. */}
        <div className="mt-8">
            ...
            {SOCIALS.map((social) => (
              <li key={social.href}>
                <a
                  ...
                  className="btn-95 !min-w-0 inline-flex !px-4 !py-1.5 text-[12px]"
                >
                  {social.name}
                </a>
              </li>
